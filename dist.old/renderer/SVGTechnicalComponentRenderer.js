...
import { lineVerticalGuide, } from "../utils/svg-helper.ts";
export class SVGTechnicalComponentRenderer extends SVGRenderer {
    ...
    render(colourIndex) {
        ...
        // centre line
        svgString += super.renderCentreLines(this.SVG_WIDTH, this.SVG_HEIGHT, false, false);
        // overview text
    ...
    renderGuidelinesFull() {
        ...
        for (let component of this.pencil.components) {
            ...
            for (const extra of component.extras) {
                svgString += lineVerticalGuide(offset + extra.offset[0] * 5, this.SVG_HEIGHT / 2 - 80, 80);
                svgString += lineVerticalGuide(offset + extra.offset[0] * 5 + extra.length * 5, this.SVG_HEIGHT / 2 - 80, 80);
            }
