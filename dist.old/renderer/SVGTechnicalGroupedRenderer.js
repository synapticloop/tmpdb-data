...
import { dimensionsHorizontal, drawTextBoldCentred, lineHorizontal, TextOrientation } from "../utils/svg-helper.ts";
...
export class SVGTechnicalGroupedRenderer extends SVGRenderer {
    ...
    render(colourIndex) {
        ...
        let midYOverride = 100;
        svgString += lineHorizontal(50, midYOverride + 4, 316, "2", "black");
        svgString += drawTextBoldCentred("Measurements", this.SVG_WIDTH / 2, midYOverride, "2.4em");
        ...
        svgString += drawTextBoldCentred("Variants", this.SVG_WIDTH / 2, midYOverride, "2.4em");
