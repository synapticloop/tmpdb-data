    ...
    if (pencilFiles.length > 0) {
        ...
        for (const [index, pencilFile] of pencilFiles.entries()) {
            ...
            for (let [index, colourComponent] of pencil.colourComponents.entries()) {
                const pencilColourOutputFileName = pencilFileName + "-colour-" + colourComponent;
                const pencilExplodedColourOutputFileName = pencilFileName + "-exploded-colour-" + colourComponent;
