...
import { drawExtra, drawOutlineCircle, drawShapeDetails } from "../utils/svg-helper.ts";
export class SVGPencilRenderer extends SVGRenderer {
    ...
    render(colourIndex) {
        // start
        let svgString = SVGPencilRenderer.SVG_START;
    ...
    renderSideComponents(colourIndex) {
        let svgString = "";
        let startX = SVGPencilRenderer.SVG_WIDTH / 2 - (this.pencil.totalLength * 5 / 2);
        let midY = SVGPencilRenderer.SVG_HEIGHT / 2;
        let colour = "white";
