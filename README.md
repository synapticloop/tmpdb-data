...
- `/data/` - for mechanical pencil data and documentation generation.
- `/documentation/` - for documentation output, or written, **NOTE:** `This 
  directory is designed to be transient` and can be deleted without side 
  effects.  Documentation can be re-generated through the 
  `npm run generate-documentation` command.
- `/meta/` - directory for meta information for the generation of pencils
