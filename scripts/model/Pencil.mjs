...
export class Pencil {
	...
	renderSvg(shouldColour) {
		...
		svgString += `<text x="${Pencil.WIDTH - 20}" y="80" font-size="1.2em" font-weight="bold" text-anchor="end" dominant-baseline="central">Materials: ${this.materials.join(", ")}</text>\n`
