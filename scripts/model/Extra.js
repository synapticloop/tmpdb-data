...
var ExtraPartDeserialiser_ts_1 = require("./deserialisers/ExtraPartDeserialiser.ts");
var Extra = function () {
    var _a;
    ...
    var _extraParts_decorators;
    var _extraParts_initializers = [];
    var _extraParts_extraInitializers = [];
    ...
    return _a = /** @class */ (function (_super) {
            ...
            function Extra() {
                ...
                _this.dimensions = __runInitializers(_this, _dimensions_initializers, void 0);
                _this.extraParts = (__runInitializers(_this, _dimensions_extraInitializers), __runInitializers(_this, _extraParts_initializers, []));
                // TODO PRIVATE
                _this.offset = (__runInitializers(_this, _extraParts_extraInitializers), __runInitializers(_this, _offset_initializers, []));
                _this.colours = (__runInitializers(_this, _offset_extraInitializers), __runInitializers(_this, _colours_initializers, []));
                _this.length = __runInitializers(_this, _colours_extraInitializers);
                return _this;
            }
            Extra.prototype.postConstruct = function (colours, colourMap) {
        ...
        (function () {
            ...
            _extraParts_decorators = [(0, json_object_mapper_1.JsonProperty)({ name: "parts", type: ExtraPart_ts_1.ExtraPart, deserializer: ExtraPartDeserialiser_ts_1.ExtraPartDeserialiser, required: true })];
            ...
            __esDecorate(null, null, _extraParts_decorators, { kind: "field", name: "extraParts", static: false, private: false, access: { has: function (obj) { return "extraParts" in obj; }, get: function (obj) { return obj.extraParts; }, set: function (obj, value) { obj.extraParts = value; } }, metadata: _metadata }, _extraParts_initializers, _extraParts_extraInitializers);
